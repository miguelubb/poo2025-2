package ejemplos.semana11.ejemploAvanzadoStreams;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (Scanner sc = new Scanner(new File("src/ejemplos/semana11/ejemploAvanzadoStreams/empleados.txt"))) {
            sc.useDelimiter(",|\r\n|[\n\r\u2028\u2029\u0085]");
            ...
            empleados.stream()
                    .sorted(Comparator
                            .comparing(Empleado::getSueldo).reversed()
                            .thenComparing(Empleado::getNombre)
                            .thenComparing(Empleado::getDepartamento)
                    )
